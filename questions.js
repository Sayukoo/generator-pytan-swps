(function (global) {
  ...
  const UWR_QUESTIONS = [
    { text: 'Podstawowe założenia przyjmowane w nauce - różnica między wiedzą naukową a potoczną', tags: ['Zestaw egzaminacyjny', 'Metodologia'] },
    { text: 'Procesy i mechanizmy samoregulacji - znaczenie dla dobrostanu i przystosowania człowieka', tags: ['Zestaw egzaminacyjny', 'Psychologia ogólna'] },
    { text: 'Rola stereotypów w spostrzeganiu i funkcjonowaniu społecznym', tags: ['Zestaw egzaminacyjny', 'Psychologia społeczna'] },
    { text: 'Wpływ społeczny - przykłady, wyznaczniki, korzyści i zagrożenia', tags: ['Zestaw egzaminacyjny', 'Psychologia społeczna'] },
    { text: 'Sytuacyjne i dyspozycyjne wyznaczniki stresu i radzenia sobie', tags: ['Zestaw egzaminacyjny', 'Psychologia kliniczna'] },
    { text: 'Stres traumatyczny - charakterystyka zjawiska i jego konsekwencji', tags: ['Zestaw egzaminacyjny', 'Psychologia kliniczna'] },
    { text: 'Emocje a motywacja - zależności, kierunek oddziaływań i wpływ na zachowanie', tags: ['Zestaw egzaminacyjny', 'Emocje i motywacja'] },
    { text: 'Adaptacyjna funkcja emocji na przykładzie dwóch wybranych emocji podstawowych', tags: ['Zestaw egzaminacyjny', 'Emocje i motywacja'] },
    { text: 'Sytuacja prawna dotycząca zawodu psychologa w Polsce', tags: ['Zestaw egzaminacyjny', 'Etyka zawodowa'] },
    { text: 'Podstawowe zasady etyczne w diagnozie, pomocy psychologicznej i badaniach naukowych według Kodeksu Etycznego Psychologa (2018)', tags: ['Zestaw egzaminacyjny', 'Etyka zawodowa'] },
    { text: 'Główne zagadnienia psychologii osobowości - struktura, rozwój i funkcje na przykładzie wybranych teorii', tags: ['Zestaw egzaminacyjny', 'Psychologia osobowości'] },
    { text: 'Aktualność różnych teorii osobowości - ich przydatność i praktyczne zastosowanie w rozumieniu kondycji i problemów człowieka współczesnego', tags: ['Zestaw egzaminacyjny', 'Psychologia osobowości'] },
    { text: 'Rola motywatorów i czynników higieny w przejawianiu zachowań obywatelskich i kontrproduktywnych w organizacji', tags: ['Zestaw egzaminacyjny', 'Psychologia organizacji'] },
    { text: 'Styl wychowania w rodzinie i jego rola w powstawaniu zaburzeń we współżyciu społecznym u dzieci', tags: ['Zestaw egzaminacyjny', 'Psychologia wychowawcza'] },
    { text: 'Niepowodzenia dzieci w nauce szkolnej - przyczyny i przeciwdziałanie niepowodzeniom szkolnym', tags: ['Zestaw egzaminacyjny', 'Psychologia wychowawcza'] },
    { text: 'Przebieg procesu badawczego w psychologii', tags: ['Zestaw egzaminacyjny', 'Metodologia'] },
    { text: 'Różnica między testami a innymi metodami diagnozy i ich znaczenie w pracy psychologa diagnosty', tags: ['Zestaw egzaminacyjny', 'Diagnoza psychologiczna'] },
    { text: 'Kryteria dobroci testu - jaką wiedzę z nich czerpie psycholog', tags: ['Zestaw egzaminacyjny', 'Psychometria'] },
    { text: 'Wybrany kwestionariusz osobowości lub skala inteligencji - budowa testu, przedmiot pomiaru, możliwości aplikacyjne i ograniczenia', tags: ['Zestaw egzaminacyjny', 'Diagnoza psychologiczna'] },
    { text: 'Procesy i mechanizmy funkcjonowania poznawczego człowieka - omów dwa wybrane i ich znaczenie w pracy psychologa', tags: ['Zestaw egzaminacyjny', 'Psychologia poznawcza'] },
    { text: 'Systemowe ujęcie rodziny - konsekwencje dla rozumienia i pracy z rodziną', tags: ['Zestaw egzaminacyjny', 'Psychoterapia'] },
    { text: 'Rola kryzysów psychicznych w ciągu życia', tags: ['Zestaw egzaminacyjny', 'Psychologia rozwoju'] },
    { text: 'Geny, rodzice, rówieśnicy – proporcje wpływów w przebiegu rozwoju człowieka', tags: ['Zestaw egzaminacyjny', 'Psychologia rozwoju'] },
    { text: 'Znaczenie temperamentu dla regulacji funkcjonowania i przystosowania człowieka', tags: ['Zestaw egzaminacyjny', 'Psychologia różnic indywidualnych'] },
    { text: 'Różnice indywidualne warunkujące adaptację psychologiczną', tags: ['Zestaw egzaminacyjny', 'Psychologia różnic indywidualnych'] },
    { text: 'Wybrane klasyczne koncepcje psychologiczne człowieka oraz ich implikacje dla współczesnej psychologii', tags: ['Zestaw egzaminacyjny', 'Historia myśli psychologicznej'] },
    { text: 'Zaburzenia osobowości - istota i kryteria rozpoznawania oraz wybrane przykłady', tags: ['Zestaw egzaminacyjny', 'Psychologia kliniczna'] },
    { text: 'Najważniejsze czynniki biologiczne, psychologiczne i społeczne sprzyjające rozwojowi problemów i zaburzeń funkcjonowania człowieka', tags: ['Zestaw egzaminacyjny', 'Psychologia kliniczna'] },
    { text: 'Nurty współczesnej psychoterapii - główne założenia i porównanie wybranych', tags: ['Zestaw egzaminacyjny', 'Psychoterapia'] },
    { text: 'Profesjonalna i nieprofesjonalna pomoc psychologiczna - charakterystyka, różnice, przykłady', tags: ['Zestaw egzaminacyjny', 'Pomoc psychologiczna'] },
  ];
